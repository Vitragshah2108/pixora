...
import { Lock, Eye, EyeOff, CheckCircle2, AlertCircle, ArrowLeft, Sparkles, ShieldCheck } from "lucide-react";
      ...
      >
        ...
        {!isSuccess ? (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-[#0d0f17]/80 border border-white/10 rounded-xl pl-11 pr-11 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all"
                />
                <button
                  type="button"
          ...
          <div className="space-y-4">
            <Link
              href="/login"
              className="w-full py-3.5 px-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-medium rounded-xl shadow-lg shadow-purple-600/30 transition-all flex items-center justify-center gap-2"
            >
