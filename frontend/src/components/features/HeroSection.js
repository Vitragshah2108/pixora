                ...
                <div className="relative group">
                  ...
                  <div className="relative flex items-center bg-zinc-950/90 backdrop-blur-md rounded-lg border border-white/10 overflow-hidden">
                    ...
                    <button 
                      ...
                      className="bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white font-medium py-4 px-6 rounded-r-lg transition-all duration-300 flex items-center"
                    >
                      <span>Search</span>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {sampleImages.map((image, idx) => (
                    <motion.div
                      ...
                      onClick={() => router.push('/login')}
                      className="group relative rounded-xl overflow-hidden aspect-[3/4] bg-zinc-900/60 backdrop-blur-sm border border-white/10 cursor-pointer"
                    >
                      <div className="absolute inset-0 overflow-hidden">
                        <Image
                          src={image.thumbnail}
                      ...
                      <div className="relative h-full w-full overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                          ...
                          <motion.button
                            ...
                            whileTap={{ scale: 0.97 }}
                            onClick={() => router.push('/login')}
                            className="self-start bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white font-medium py-3 px-5 rounded-lg border border-white/20 transition-all flex items-center cursor-pointer"
                          >
