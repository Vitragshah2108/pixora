          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              ...
              <button 
                ...
                className="mt-4 inline-flex items-center px-5 py-2.5 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white text-sm font-medium transition-colors duration-300 cursor-pointer"
              >
                See in action
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {secondaryFeatures.map((feature, idx) => (
              <motion.div 
                ...
                onClick={() => router.push('/login')}
                className="p-6 bg-white/5 hover:bg-white/10 rounded-xl border border-white/10 transition-colors duration-300 cursor-pointer"
              >
          ...
          <div className="relative p-12 flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="px-8 py-4 rounded-lg bg-white text-zinc-900 font-medium hover:bg-gray-100 transition-colors duration-300 flex items-center justify-center shadow-lg shadow-white/10 cursor-pointer"
              >
              ...
              <button 
                ...
                className="px-8 py-4 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white font-medium hover:bg-white/20 transition-colors duration-300 flex items-center justify-center cursor-pointer"
              >
