        ...
        >
          {benefits.map((benefit, idx) => (
            <motion.div
              ...
              className="relative group overflow-hidden rounded-xl bg-white/5 border border-white/10 p-6 hover:bg-white/10 transition-colors duration-300 cursor-pointer"
            >
              {/* Gradient accent */}
        ...
        >
          <div className="relative rounded-xl overflow-hidden aspect-video bg-zinc-900/60 border border-white/10 group">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
              ...
              <motion.button 
                onClick={() => router.push('/login')}
                className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white shadow-lg shadow-violet-900/30 cursor-pointer"
